...
#    plot_base64.append(open(path+'/07.report/div/nUMI_chsize.div',"r").read())
    plot_order = ['plot1','plot3','plot4','plot6','plot7']
...
def write_param_to_template():
    ...
    report=html.safe_substitute(sample_info=ID, samplename=stat['samplename'],\
                  ...
                  #  cluster_cell=stat['cluster_cell'],\
                    ...
                    plot4=plot_dict['plot4'],plot6=plot_dict['plot6'],plot7=plot_dict['plot7'],r_m_geno=stat['r_m_geno'], 
            r_m_ex=stat['r_m_ex'], 
            ...
            Mouse_mean_UMIs=stat['Mouse_mean_UMIs'],intron_boolean=stat['intron_boolean']
